---
title: "About"
description: "About B.E.N. and the Shades of Singularity project."
---
...
These essays are my attempt to close that gap, or at least to make it visible.
...
These essays try to apply that method: asking what structures the future requires, and why the answers currently on offer (regulate, skill up, trust the market) are structurally inadequate.

I should be honest about the limits. These essays diagnose more than they prescribe. They name what we need more than they specify how to build it. The institutional design work that AI demands is larger than any single author. It requires economists, legislators, engineers, and citizens working together. What I hope these essays do is make the problem visible enough, and the false remedies untenable enough, that the real work can begin on honest foundations.

## On Writing With AI

These essays were written in collaboration with Claude, Anthropic's AI. I want to be transparent about this. It's an argument, not a disclaimer.

A collection about the futures AI is creating cannot be written as if AI doesn't exist. The tool is part of the subject. Using AI to explore what AI might do to civilization is not a shortcut. It is a necessary part of the method. You would not write about the ocean without getting in the water.

Concretely: I brought the questions, the angles, the moral convictions, and the editorial judgment. Claude brought analytical scale: the ability to hold 29 scenarios in working memory simultaneously, to stress-test arguments against counterarguments in real time, to find structural connections across domains that a single human mind would take months to map. The 29-scenario taxonomy, the identification of 22 gaps the mainstream discourse misses, the thematic architecture of the nine clusters that became these twelve essays. All of this emerged from a collaboration that neither of us could have produced alone.

This is itself evidence for one of the collection's central arguments: AI is an extraordinary cognitive amplifier. A $20 subscription gave me the analytical capacity of a small research team. That is the democratization these essays describe, and the trap. Because the same tool that helped me write about institutional design is the tool that is making institutional design urgent. The fact that one person with AI can produce work of this scope is precisely why we need to think seriously about what happens when everyone can, and when the institutions that once required hundreds of experts can be interrogated, stress-tested, and perhaps undermined by anyone with a laptop.
...
This is what human-AI collaboration looks like when it works. These essays argue that we need to design institutions for a world where it is the norm.

## Why Now

I wrote these essays with a sense of urgency that I want to be honest about.
