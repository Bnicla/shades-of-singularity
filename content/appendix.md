...
1. **Intelligence Explosion (#20): 10 pts** -- Outcome swings from extinction to transcendence based entirely on whether alignment is solved first.
2. **The Singleton (#21): 9 pts** -- Whether a dominant AI power becomes benevolent governance or permanent tyranny is a pure governance question.
3. **Cognitive Enhancement (#18): 7 pts** -- Universal access transforms this from the deepest inequality ever into the greatest equalizer ever. The difference is policy.
4. **Labor Erosion (#1) / Neo-Feudalism (#15) / Ecological Reckoning (#10): 6 pts each** -- Where economic and environmental governance can flip outcomes from severely negative to genuinely positive.

**Lowest Governance Dividends** (limited institutional leverage):

1. **Human Extinction (#27): 0 pts** -- If it happens, governance failed. Only prevention counts.
2. **Transcendence (#28): Unknown** -- Beyond our ability to evaluate or govern from this side.
